...
public class Login_fragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        email= view.findViewById(R.id.editTextUserName);
        password =view.findViewById(R.id.editTextPassword);
        progress =view.findViewById(R.id.progressBar);
        progress.setVisibility(View.GONE);
        autoilogin =view.findViewById(R.id.checkBox_autoLogin);
        ...
        recover = view.findViewById(R.id.recoverytextview);
    ...
    private void login_acction()
    {

    }
    private void replace () {
        FragmentTransaction ft = getParentFragmentManager().beginTransaction();
        ft.replace(R.id.fragmentContainerView, new FragmentRecovery());
        ft.commit();
    }
}