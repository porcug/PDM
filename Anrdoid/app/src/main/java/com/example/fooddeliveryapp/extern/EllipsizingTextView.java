package com.example.fooddeliveryapp.extern;/*
 * Copyright (C) 2011 Micah Hainline
 * Copyright (C) 2012 Triposo
 * Copyright (C) 2013 Paul Imhoff
 * Copyright (C) 2014 Shahin Yousefi
 * Copyright (C) 2021 Boaca Emanuel
 *
...
public class EllipsizingTextView extends androidx.appcompat.widget.AppCompatTextView {
    ...
    private abstract class EllipsizeStrategy {
        ...
        protected Layout createWorkingLayout(CharSequence workingText) {
            StaticLayout.Builder b= StaticLayout.Builder.obtain(workingText,0, workingText.length(),getPaint(),getMeasuredWidth() - getPaddingLeft() - getPaddingRight());
                                b.setAlignment(Alignment.ALIGN_NORMAL);
                                b.setLineSpacing(mLineAddVertPad,mLineSpacingMult);
            return               b.build();
    ...
    private class EllipsizeEndStrategy extends EllipsizeStrategy {
        ...
        protected CharSequence createEllipsizedText(CharSequence fullText) {
            try {
                ...
                int cutOffIndex = layout.getLineEnd(getFullyVisibleLinesCount());
